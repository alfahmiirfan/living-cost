                ...
                <div class="w-[25%] pr-6">
                    ...
                    <div class="max-w-sm mx-auto">
                        <select name="kategori" id="kategori" class="bg-gray-50 border border-gray-300  text-sm font-light rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            ...
                            <option value="{{ $item['id'] }}" @if($item['nama']===$pengeluaran->kategori) selected @endif >{{ $item['nama'] }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                <div class="w-[25%] pr-6">
                    ...
                    <div class="pb-6  ">
                        ...
                        <div class="relative">
                            ...
                            <input name="jumlah" type="number" id="default-search" class="px-5 py-2.5 block w-full text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan jumlah" required value="{{ $pengeluaran->jumlah }}" />
                        </div>
                    </div>
                </div>
                <div class="w-[25%] pr-6">
                    ...
                    <div class="pb-6  ">
                        ...
                        <div class="flex items-center font-light relative">Rp.
                            ...
                            <input name="harga" type="number" id="default-search" class="px-5 py-2.5 block w-full text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan harga" required value="{{ $pengeluaran->harga }}" />
                        </div>
                    </div>
                </div>
                <div class="w-[25%]">
                    ...
                    <div class="pb-6  ">
                        ...
                        <div class="relative">
                            ...
                            <input name="tanggal" type="text" id="tanggal" class="px-5 py-2.5 block w-full text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan tanggal" required value="{{ $pengeluaran->tanggal }}" />
                        </div>
                    </div>
                </div>
            </div>
