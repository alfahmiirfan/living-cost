    ...
    <x-layout-super-admin>
        ...
        <div class="flex">
            ...
            <div class="absolute top-30 right-10 flex justify-between items-center rounded-md">
                <a href="#  ">
                    <button id="importBtn" type="button" class="px-5 py-1 text-sm font-medium text-black inline-flex items-center bg-[#F5E81D] hover:bg-yellow-300 focus:ring-4 focus:outline-none focus:ring-yellow-400 rounded-lg text-center dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-800">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-import">
                            ...
                            <path d="M8 5H4a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-4" /></svg>
                        Import Data Siswa
                    </button>
                </a>
                ...
                <a href="Pendataan-TambahSuperAdmin">
                    <button type="button" class="ml-2 px-5 py-1 text-sm font-medium text-black inline-flex items-center bg-[#F5E81D] hover:bg-yellow-300 focus:ring-4 focus:outline-none focus:ring-yellow-400 rounded-lg text-center dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-800">
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 text-sm">
                        ...
                        <td class="px-6 py-2">
                            <div class="flex ">
                                ...
                                <a href="/DetailPembayaranSiswa-SuperAdmin" class="text-white bg-yale-blue hover:bg-yale-blue focus:ring-4 focus:outline-none font-medium rounded-lg text-sm inline-flex items-center w-8 text-center justify-center">
