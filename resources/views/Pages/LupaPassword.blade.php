        ...
        <div class="flex w-full lg:w-1/2 justify-center items-center bg-yale-blue space-y-8">
            <div class="w-full px-12 md:px-32 lg:px-24">
                <form action="" method="POST" class="bg-white rounded-md shadow-2xl p-10">
                    @csrf
                    <h1 class="text-gray-800 font-bold text-2xl mb-1 text-center pb-4">Lupa Password</h1>
                    ...
                    <div class="pt-5 pb-5">
                        <button type="submit" class=" bg-[#F5E81D] w-full justify-center  pt-2 py-2 rounded-xl hover:bg-yellow-300 hover:-translate-y-1 transition-all duration-500 text-black font-semibold">Kirim Kode OTP</button>
                    </div>
                </form>
            </div>
        </div>
