...
<body>
    <x-layout-admin>
        <x-navbar-admin title="Pengelolaan Keuangan - Pengeluaran(Tambah)" />
                <div class=" ">
            <div class="">
        ...
        <div class="flex pt-6 ">
            <div class="w-[25%] pr-6">
                ...
                <form class="max-w-sm mx-auto">
                    <select id="kategori" class="bg-gray-50 border border-gray-300  text-sm font-light rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <option value="">Pangan</option>
                        <option value="">Snack</option>
                        <option value="">Obat-obatan</option>
