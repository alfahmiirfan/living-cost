                ...
                <tbody>
                    @foreach ($data as $key => $item)
                        <tr class="border-b bg-white text-sm dark:border-gray-700 dark:bg-gray-800">
                            ...
                            <td class="px-2 py-2">
                                <span class="inline-flex items-center rounded-md bg-[#32D62F] px-8 py-2 text-xs font-medium text-black ring-1 ring-inset ring-green-600/20">{{ $item->status }}</span>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
