...
<body>
    <x-layout-user>
        ...
        <div class="wrap">
            <div class="wrap-pay">
                <div class="pb-2">
                    <a href="/VirtualAccountUser" class="bank-option" data-bank="BANK BRI" data-image="image/bri.svg">
                ...
                <div class="pb-2">
                    <a href="/VirtualAccountUser" class="bank-option" data-bank="BANK BNI" data-image="image/bni.svg">
                        <div class="border-2 flex h-18 w-full col-span-1 border-gray-300 rounded-md">
                            <div class="p-4 flex">
            ...
            <div class="pb-2">
                <a href="/VirtualAccountUser" class="bank-option" data-bank="BANK BCA" data-image="image/bca.svg">
                    <div class="border-2 flex h-18 w-full col-span-1 border-gray-300 rounded-md">
                        <div class="p-4 flex">
