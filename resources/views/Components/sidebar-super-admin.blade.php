<div class="fixed left-0 top-0">
    <aside class="bg-[#085288] fixed z-10 pb-8 top-0 px-6 w-50% flex flex-col justify-between h-screen border-r transition duration-300 w-[20%]    ">
        ...
        <ul class="">
            ...
            <div class=" pl-4 py-1">
                <button type="button" class="flex items-center w-full text-base font-normal text-white" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                    <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span class="flex-1 pl-4 text-left grayspace-nowrap" sidebar-toggle-item>Pengelolaan Keuangan </span>
                ...
                <ul id="dropdown-example" class="hidden py-2 space-y-2">
                    ...
                    <li>
                        <a href="/PengeluaranSuperAdmin" class="flex items-center w-full p-2 text-base font-normal text-white pl-11">Pengeluaran</a>
                    </li>
                </ul>
            </div>
            <div class="">
                <li>
                    <a href="/PendataanSiswaSuperAdmin" class="px-4 py-1 flex items-center space-x-4 rounded-md text-white group">
                        <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="">
                <li>
                    <a href="/PengelolaanAdminSuperAdmin" class="px-4 py-1 flex items-center space-x-4 rounded-md text-white group">
                        <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="pb-32">
                <li>
                    <a href="/LaporanSuperAdmin" class="px-4 py-1 flex items-center space-x-4 rounded-md text-white group">
                        <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="px-16 flex justify-between items-center rounded-md">
            <a href="#">
